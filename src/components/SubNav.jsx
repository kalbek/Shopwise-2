...
export default function SubNav() {
  return (
    <ul className=" hidden md:grid md:grid-cols-4 lg:grid-cols-6 md:flex-wrap bg-darksecondary text-lightsecondary font-medium w-full gap-2 h-auto px-[9%]  justify-between items-center">
      <li className="md:scale-[120%] flex md:gap-[10%] lg:gap-[25%] py-2">
      ...
      <li className="md:scale-[120%] flex md:gap-[10%] lg:gap-[25%]">
        <span className="flex gap-2 cursor-pointer">
      ...
      <li className="md:scale-[120%] flex  md:gap-[5%] lg:gap-25%]">
        <span className="flex gap-2 cursor-pointer">
